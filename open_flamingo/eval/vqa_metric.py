...
class VQAEval:
    ...
    def evaluate(self, quesIds=None):
        ...
        for quesId in quesIds:
            ...
            self.setEvalQA(quesId, avgGTAcc, question, resAns, gts[quesId]["answers"])
    ...
    def setEvalQA(self, quesId, acc, question, resAns, answers):
        self.evalQA[quesId] = [round(100 * acc, self.n), question, resAns, answers]
...
def compute_vqa_accuracy(result_json_path, question_json_path, annotation_json_path):
    ...
    return vqaEval.accuracy["overall"], vqaEval.evalQA
