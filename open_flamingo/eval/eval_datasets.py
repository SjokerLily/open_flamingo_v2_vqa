...
# from open_flamingo_v2.open_flamingo.eval.classification_utils import IMAGENET_1K_CLASS_ID_TO_LABEL
...
class VQADataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if not self.is_train:
            question_id = question['question_id']
            results["SIIR"] = [i[2] for i in self.retrieval_set[question_id]["images"]]
            results["SQQR"] = [i[2] for i in self.retrieval_set[question_id]["captions"]]
